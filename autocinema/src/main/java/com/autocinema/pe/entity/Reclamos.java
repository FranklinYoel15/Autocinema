...
public class Reclamos {
	...
	public Reclamos(Long id, String usuario_id, String sede_id, String confiteria_id, String descripcion,
			String estado) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Reclamos [id=" + id + ", usuario_id=" + usuario_id + ", sede_id=" + sede_id + ", confiteria_id="
